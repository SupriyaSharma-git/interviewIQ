 ...
 */
export function observabilityList(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => operations.ListObservabilityDestinationsRequest$outboundSchema.optional()
    ...
    const body = null;
    const path = pathToFunc("/observability/destinations")();
    ...
    const nextFunc = (responseData) => {
        ...
        const nextVal = () => observabilityList(client, {
            ...request,
            offset: nextOffset,
        }, options);
...
//# sourceMappingURL=observabilityList.js.map