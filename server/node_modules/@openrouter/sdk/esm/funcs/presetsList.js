 ...
 */
export function presetsList(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => operations.ListPresetsRequest$outboundSchema.optional().parse(value), "Input validation failed");
    if (!parsed.ok) {
        return [haltIterator(parsed), { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = pathToFunc("/presets")();
    ...
    const [result, raw] = await M.match(M.json(200, operations.ListPresetsResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        const nextVal = () => presetsList(client, {
            ...request,
            offset: nextOffset,
        }, options);
...
//# sourceMappingURL=presetsList.js.map