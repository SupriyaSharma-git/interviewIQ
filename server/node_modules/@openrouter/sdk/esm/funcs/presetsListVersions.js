 ...
 */
export function presetsListVersions(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => operations.ListPresetVersionsRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const path = pathToFunc("/presets/{slug}/versions")(pathParams);
    ...
    const [result, raw] = await M.match(M.json(200, operations.ListPresetVersionsResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        const nextVal = () => presetsListVersions(client, {
            ...request,
            offset: nextOffset,
        }, options);
...
//# sourceMappingURL=presetsListVersions.js.map