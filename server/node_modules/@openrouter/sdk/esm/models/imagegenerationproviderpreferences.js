...
/** @internal */
export const ImageGenerationProviderPreferencesIgnore$outboundSchema = z.union([ProviderName$outboundSchema, z.string()]);
export function imageGenerationProviderPreferencesIgnoreToJSON(imageGenerationProviderPreferencesIgnore) {
    return JSON.stringify(ImageGenerationProviderPreferencesIgnore$outboundSchema.parse(imageGenerationProviderPreferencesIgnore));
}
/** @internal */
export const ImageGenerationProviderPreferencesOnly$outboundSchema = z.union([ProviderName$outboundSchema, z.string()]);
export function imageGenerationProviderPreferencesOnlyToJSON(imageGenerationProviderPreferencesOnly) {
    return JSON.stringify(ImageGenerationProviderPreferencesOnly$outboundSchema.parse(imageGenerationProviderPreferencesOnly));
}
/** @internal */
...
export function imageGenerationProviderPreferencesOptionsToJSON(imageGenerationProviderPreferencesOptions) {
    return JSON.stringify(ImageGenerationProviderPreferencesOptions$outboundSchema.parse(imageGenerationProviderPreferencesOptions));
}
/** @internal */
export const ImageGenerationProviderPreferencesOrder$outboundSchema = z.union([ProviderName$outboundSchema, z.string()]);
export function imageGenerationProviderPreferencesOrderToJSON(imageGenerationProviderPreferencesOrder) {
...
/** @internal */
export const ImageGenerationProviderPreferences$outboundSchema = z.object({
...
export function imageGenerationProviderPreferencesToJSON(imageGenerationProviderPreferences) {
    return JSON.stringify(ImageGenerationProviderPreferences$outboundSchema.parse(imageGenerationProviderPreferences));
}
//# sourceMappingURL=imagegenerationproviderpreferences.js.map