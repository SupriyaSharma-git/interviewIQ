...
export declare const EditTypeInputTokens: {
...
export declare const KeepEnum: {
    readonly All: "all";
};
export type KeepEnum = ClosedEnum<typeof KeepEnum>;
export declare const KeepType: {
    readonly All: "all";
};
...
export type Edit = EditClearToolUses20250919 | EditClearThinking20251015 | EditCompact20260112;
...
export type ToolChoice = ToolChoiceAuto | ToolChoiceAny | ToolChoiceNone | ToolChoiceTool;
...
export type NameAdvisor = ClosedEnum<typeof NameAdvisor>;
export declare const TypeAdvisor20260301: {
    readonly Advisor20260301: "advisor_20260301";
};
export type TypeAdvisor20260301 = ClosedEnum<typeof TypeAdvisor20260301>;
...
export declare const NameWebSearch2: {
    readonly WebSearch: "web_search";
};
export type NameWebSearch2 = ClosedEnum<typeof NameWebSearch2>;
export declare const TypeWebSearch20260209: {
    readonly WebSearch20260209: "web_search_20260209";
};
...
export declare const NameWebSearch1: {
    readonly WebSearch: "web_search";
};
export type NameWebSearch1 = ClosedEnum<typeof NameWebSearch1>;
export declare const TypeWebSearch20250305: {
    readonly WebSearch20250305: "web_search_20250305";
};
...
export declare const NameStrReplaceEditor: {
    readonly StrReplaceEditor: "str_replace_editor";
};
export type NameStrReplaceEditor = ClosedEnum<typeof NameStrReplaceEditor>;
export declare const TypeTextEditor20250124: {
    readonly TextEditor20250124: "text_editor_20250124";
};
...
export declare const NameBash: {
    readonly Bash: "bash";
};
export type NameBash = ClosedEnum<typeof NameBash>;
export declare const TypeBash20250124: {
    readonly Bash20250124: "bash_20250124";
};
...
/** @internal */
export declare const EditTypeInputTokens$outboundSchema: z.ZodEnum<typeof EditTypeInputTokens>;
/** @internal */
...
/** @internal */
export declare const TriggerInputTokens$outboundSchema: z.ZodType<TriggerInputTokens$Outbound, TriggerInputTokens>;
export declare function triggerInputTokensToJSON(triggerInputTokens: TriggerInputTokens): string;
/** @internal */
...
/** @internal */
export declare const EditCompact20260112$outboundSchema: z.ZodType<EditCompact20260112$Outbound, EditCompact20260112>;
export declare function editCompact20260112ToJSON(editCompact20260112: EditCompact20260112): string;
/** @internal */
export declare const KeepEnum$outboundSchema: z.ZodEnum<typeof KeepEnum>;
/** @internal */
export declare const KeepType$outboundSchema: z.ZodEnum<typeof KeepType>;
/** @internal */
export type KeepAll$Outbound = {
    type: string;
};
/** @internal */
export declare const KeepAll$outboundSchema: z.ZodType<KeepAll$Outbound, KeepAll>;
export declare function keepAllToJSON(keepAll: KeepAll): string;
/** @internal */
export type Keep$Outbound = AnthropicThinkingTurns$Outbound | KeepAll$Outbound | string;
/** @internal */
export declare const Keep$outboundSchema: z.ZodType<Keep$Outbound, Keep>;
export declare function keepToJSON(keep: Keep): string;
/** @internal */
export type EditClearThinking20251015$Outbound = {
    keep?: AnthropicThinkingTurns$Outbound | KeepAll$Outbound | string | undefined;
    type: "clear_thinking_20251015";
};
/** @internal */
...
/** @internal */
export type Trigger$Outbound = AnthropicInputTokensTrigger$Outbound | AnthropicToolUsesTrigger$Outbound;
/** @internal */
export declare const Trigger$outboundSchema: z.ZodType<Trigger$Outbound, Trigger>;
export declare function triggerToJSON(trigger: Trigger): string;
/** @internal */
...
/** @internal */
export declare const EditClearToolUses20250919$outboundSchema: z.ZodType<EditClearToolUses20250919$Outbound, EditClearToolUses20250919>;
export declare function editClearToolUses20250919ToJSON(editClearToolUses20250919: EditClearToolUses20250919): string;
/** @internal */
export type Edit$Outbound = EditClearToolUses20250919$Outbound | EditClearThinking20251015$Outbound | EditCompact20260112$Outbound;
/** @internal */
export declare const Edit$outboundSchema: z.ZodType<Edit$Outbound, Edit>;
export declare function editToJSON(edit: Edit): string;
/** @internal */
export type ContextManagement$Outbound = {
    edits?: Array<EditClearToolUses20250919$Outbound | EditClearThinking20251015$Outbound | EditCompact20260112$Outbound> | undefined;
};
/** @internal */
...
/** @internal */
export declare const Speed$outboundSchema: z.ZodType<string, Speed>;
/** @internal */
export type System$Outbound = string | Array<AnthropicTextBlockParam$Outbound>;
/** @internal */
export declare const System$outboundSchema: z.ZodType<System$Outbound, System>;
...
/** @internal */
export declare const ThinkingAdaptive$outboundSchema: z.ZodType<ThinkingAdaptive$Outbound, ThinkingAdaptive>;
export declare function thinkingAdaptiveToJSON(thinkingAdaptive: ThinkingAdaptive): string;
/** @internal */
export type ThinkingDisabled$Outbound = {
    type: "disabled";
};
/** @internal */
export declare const ThinkingDisabled$outboundSchema: z.ZodType<ThinkingDisabled$Outbound, ThinkingDisabled>;
...
/** @internal */
export declare const ThinkingEnabled$outboundSchema: z.ZodType<ThinkingEnabled$Outbound, ThinkingEnabled>;
export declare function thinkingEnabledToJSON(thinkingEnabled: ThinkingEnabled): string;
/** @internal */
export type Thinking$Outbound = ThinkingEnabled$Outbound | ThinkingDisabled$Outbound | ThinkingAdaptive$Outbound;
/** @internal */
...
/** @internal */
export declare const ToolChoiceTool$outboundSchema: z.ZodType<ToolChoiceTool$Outbound, ToolChoiceTool>;
export declare function toolChoiceToolToJSON(toolChoiceTool: ToolChoiceTool): string;
/** @internal */
export type ToolChoiceNone$Outbound = {
    type: "none";
};
/** @internal */
export declare const ToolChoiceNone$outboundSchema: z.ZodType<ToolChoiceNone$Outbound, ToolChoiceNone>;
export declare function toolChoiceNoneToJSON(toolChoiceNone: ToolChoiceNone): string;
/** @internal */
...
/** @internal */
export declare const ToolChoiceAny$outboundSchema: z.ZodType<ToolChoiceAny$Outbound, ToolChoiceAny>;
export declare function toolChoiceAnyToJSON(toolChoiceAny: ToolChoiceAny): string;
/** @internal */
...
/** @internal */
export declare const ToolChoiceAuto$outboundSchema: z.ZodType<ToolChoiceAuto$Outbound, ToolChoiceAuto>;
export declare function toolChoiceAutoToJSON(toolChoiceAuto: ToolChoiceAuto): string;
/** @internal */
export type ToolChoice$Outbound = ToolChoiceAuto$Outbound | ToolChoiceAny$Outbound | ToolChoiceNone$Outbound | ToolChoiceTool$Outbound;
/** @internal */
...
/** @internal */
export type MessagesRequestTool$Outbound = {
    type: string;
...
/** @internal */
export declare const ToolAdvisor20260301$outboundSchema: z.ZodType<ToolAdvisor20260301$Outbound, ToolAdvisor20260301>;
export declare function toolAdvisor20260301ToJSON(toolAdvisor20260301: ToolAdvisor20260301): string;
/** @internal */
export declare const NameWebSearch2$outboundSchema: z.ZodEnum<typeof NameWebSearch2>;
/** @internal */
export declare const TypeWebSearch20260209$outboundSchema: z.ZodEnum<typeof TypeWebSearch20260209>;
/** @internal */
export type ToolWebSearch20260209$Outbound = {
    ...
    name: string;
    type: string;
    user_location?: AnthropicWebSearchToolUserLocation$Outbound | null | undefined;
};
/** @internal */
export declare const ToolWebSearch20260209$outboundSchema: z.ZodType<ToolWebSearch20260209$Outbound, ToolWebSearch20260209>;
export declare function toolWebSearch20260209ToJSON(toolWebSearch20260209: ToolWebSearch20260209): string;
/** @internal */
export declare const NameWebSearch1$outboundSchema: z.ZodEnum<typeof NameWebSearch1>;
/** @internal */
export declare const TypeWebSearch20250305$outboundSchema: z.ZodEnum<typeof TypeWebSearch20250305>;
/** @internal */
...
/** @internal */
export declare const ToolWebSearch20250305$outboundSchema: z.ZodType<ToolWebSearch20250305$Outbound, ToolWebSearch20250305>;
export declare function toolWebSearch20250305ToJSON(toolWebSearch20250305: ToolWebSearch20250305): string;
/** @internal */
export declare const NameStrReplaceEditor$outboundSchema: z.ZodEnum<typeof NameStrReplaceEditor>;
/** @internal */
export declare const TypeTextEditor20250124$outboundSchema: z.ZodEnum<typeof TypeTextEditor20250124>;
/** @internal */
...
/** @internal */
export declare const ToolTextEditor20250124$outboundSchema: z.ZodType<ToolTextEditor20250124$Outbound, ToolTextEditor20250124>;
export declare function toolTextEditor20250124ToJSON(toolTextEditor20250124: ToolTextEditor20250124): string;
/** @internal */
export declare const NameBash$outboundSchema: z.ZodEnum<typeof NameBash>;
/** @internal */
export declare const TypeBash20250124$outboundSchema: z.ZodEnum<typeof TypeBash20250124>;
/** @internal */
...
/** @internal */
export declare const ToolBash20250124$outboundSchema: z.ZodType<ToolBash20250124$Outbound, ToolBash20250124>;
...
/** @internal */
export declare const InputSchema$outboundSchema: z.ZodType<InputSchema$Outbound, InputSchema>;
export declare function inputSchemaToJSON(inputSchema: InputSchema): string;
/** @internal */
export declare const ToolTypeCustom$outboundSchema: z.ZodEnum<typeof ToolTypeCustom>;
/** @internal */
...
/** @internal */
export declare const MessagesRequest$outboundSchema: z.ZodType<MessagesRequest$Outbound, MessagesRequest>;
export declare function messagesRequestToJSON(messagesRequest: MessagesRequest): string;
//# sourceMappingURL=messagesrequest.d.ts.map