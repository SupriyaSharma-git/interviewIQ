...
import { ChatReasoningSummaryVerbosityEnum } from "./chatreasoningsummaryverbosityenum.js";
 ...
 * Shorthand for setting reasoning effort. Equivalent to setting reasoning.effort. Cannot be used simultaneously with reasoning.effort if they differ.
 */
export type ChatRequestReasoningEffort = OpenEnum<typeof ChatRequestReasoningEffort>;
/**
...
/** @internal */
export declare const ChatRequestEffort$outboundSchema: z.ZodType<string, ChatRequestEffort>;
/** @internal */
...
/** @internal */
export declare const ChatRequestReasoning$outboundSchema: z.ZodType<ChatRequestReasoning$Outbound, ChatRequestReasoning>;
export declare function chatRequestReasoningToJSON(chatRequestReasoning: ChatRequestReasoning): string;
/** @internal */
