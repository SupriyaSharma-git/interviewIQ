...
/** @internal */
export const ChatRequestEffort$outboundSchema = openEnums.outboundSchema(ChatRequestEffort);
/** @internal */
export const ChatRequestReasoning$outboundSchema = z.object({
...
export function chatRequestReasoningToJSON(chatRequestReasoning) {
    return JSON.stringify(ChatRequestReasoning$outboundSchema.parse(chatRequestReasoning));
}
/** @internal */
export const ChatRequestReasoningEffort$outboundSchema = openEnums.outboundSchema(ChatRequestReasoningEffort);
/** @internal */
