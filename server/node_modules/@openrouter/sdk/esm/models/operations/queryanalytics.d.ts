...
/** @internal */
export declare const Filter$outboundSchema: z.ZodType<Filter$Outbound, Filter>;
export declare function filterToJSON(filter: Filter): string;
/** @internal */
export declare const Direction$outboundSchema: z.ZodType<string, Direction>;
/** @internal */
...
/** @internal */
export declare const OrderBy$outboundSchema: z.ZodType<OrderBy$Outbound, OrderBy>;
export declare function orderByToJSON(orderBy: OrderBy): string;
/** @internal */
...
/** @internal */
export declare const TimeRange$outboundSchema: z.ZodType<TimeRange$Outbound, TimeRange>;
...
/** @internal */
export declare const QueryAnalyticsRequestBody$outboundSchema: z.ZodType<QueryAnalyticsRequestBody$Outbound, QueryAnalyticsRequestBody>;
export declare function queryAnalyticsRequestBodyToJSON(queryAnalyticsRequestBody: QueryAnalyticsRequestBody): string;
/** @internal */
...
/** @internal */
export declare const QueryAnalyticsRequest$outboundSchema: z.ZodType<QueryAnalyticsRequest$Outbound, QueryAnalyticsRequest>;
export declare function queryAnalyticsRequestToJSON(queryAnalyticsRequest: QueryAnalyticsRequest): string;
/** @internal */
export declare const QueryAnalyticsData1$inboundSchema: z.ZodType<QueryAnalyticsData1, unknown>;
export declare function queryAnalyticsData1FromJSON(jsonString: string): SafeParseResult<QueryAnalyticsData1, SDKValidationError>;
/** @internal */
...
/** @internal */
export declare const QueryAnalyticsData2$inboundSchema: z.ZodType<QueryAnalyticsData2, unknown>;
export declare function queryAnalyticsData2FromJSON(jsonString: string): SafeParseResult<QueryAnalyticsData2, SDKValidationError>;
/** @internal */
export declare const QueryAnalyticsResponse$inboundSchema: z.ZodType<QueryAnalyticsResponse, unknown>;
export declare function queryAnalyticsResponseFromJSON(jsonString: string): SafeParseResult<QueryAnalyticsResponse, SDKValidationError>;
