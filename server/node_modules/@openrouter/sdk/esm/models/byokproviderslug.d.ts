 ...
 */
export declare const BYOKProviderSlug: {
    readonly Ai21: "ai21";
 ...
 * The upstream provider this credential authenticates against, as a lowercase slug (e.g. `openai`, `anthropic`, `amazon-bedrock`).
 */
export type BYOKProviderSlug = OpenEnum<typeof BYOKProviderSlug>;
/** @internal */
export declare const BYOKProviderSlug$inboundSchema: z.ZodType<BYOKProviderSlug, unknown>;
/** @internal */
export declare const BYOKProviderSlug$outboundSchema: z.ZodType<string, BYOKProviderSlug>;
//# sourceMappingURL=byokproviderslug.d.ts.map