...
const Step3Report = ({ report }) => {
  ...
  if (finalScore >= 8) {
    ...
    performanceText = "Significant improvement reequired.";
  ...
  const downloadPDF = (report) => {
    ...
    doc.text("Interview Analytics Report", pageWidth / 2, currentY, {
      align: "center",
    });
    currentY += 5;
              ...
              {questionWiseScore.map((q, i) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4">
                    ...
                    <div className="bg-green-100 text-gray-600 px-3 py-1 rounded-full font-bold text-xs sm:text-sm w-fit">
                      {q.score ?? 0}/10
                    </div>
                  </div>
