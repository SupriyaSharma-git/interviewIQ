          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-28">
            {[
              ...
              },
              {
                ...
                desc: "Real interview pressure with time trace.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
                ...
                ${index === 2 ? "rotate-[-3deg]" : ""}`}
              >
                <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-green-500 text-gray-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg">
                  {item.icon}
                </div>
                <div className="text-xs text-green-600 font-semibold mb-2 tracking-wide">
                  <div>{item.step}</div>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {[
                ...
                },
                {
                  ...
                  desc: "Detailed strengths, weaknesses and improvement insigths.",
                },
                {
                  image: analyticsImg,
                  icon: <BsBarChart size={20} />,
